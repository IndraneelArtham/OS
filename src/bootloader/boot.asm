...
.after:
    ...
    ; instead of relying on data of formatted disk
    push es
    mov ah, 08h
    int 13h
    jc floppy_error
    ...
    inc ax                              ; division remainder != 0, add 1
                                        ; this means there exists a sector which is only partially filled
.root_dir_after:
...
.read_finish:
    ...
    cli                                 ; disable interrupts, cant escape "halt" state now
    hlt
...
wait_key_and_reboot:
    ...
    jmp 0FFFFh:0                    ; jump to beginning of BIOS, reboots system

.halt:
    cli                             ; disbale interrupts, this way we cant get out of halt state
    jmp .halt
